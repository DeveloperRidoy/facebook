...
Router.route("/auth/logout").get(protect(), logoutUser());

Router.route("/auth/quick-login/:id").get(checkId(), quickLogin());

Router.route("/:id").all(checkId()).get(getUserById()).delete(deleteUserById());

Router.route("/name/:name").get(getUsersByName());
